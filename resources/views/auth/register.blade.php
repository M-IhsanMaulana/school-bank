                ...
                <div class="row">
                    <div
                        ...
                        <div class="login-brand">
                            <img src="{{ asset('assets/img/seventeen-bank.svg') }}" alt="logo" width="100"
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h4>Register</h4>
                                <hr>
                                <span class="text-muted">Silahkan buat akun anda terlebih dahulu.</span>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-6">
                                            ...
                                            <input id="name" type="text" class="form-control" name="name"
                                                autofocus placeholder="Silahkan masukan nama akun anda">
                                            @error('name')
